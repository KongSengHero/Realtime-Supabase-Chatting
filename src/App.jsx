    ...
    return (
      <div className="min-h-screen w-full bg-[#101216] flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="relative flex flex-col items-center animate-pulse">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-[#1b2838] to-[#2a475e] border border-[#3b82f6] flex items-center justify-center shadow-lg shadow-[#3b82f6]/20 mb-4 animate-spin">
