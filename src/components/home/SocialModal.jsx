                    ...
                    {tabs.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex-1 py-3 text-xs font-semibold tracking-wider uppercase border-b-2 flex items-center justify-center gap-2 cursor-pointer transition-all ${activeTab === tab.id
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="relative">
                                            {friend.profile_url ? (
                                                ...
                                                <div className="w-10 h-10 rounded-xl bg-linear-to-tr from-[#1b2838] to-[#2a475e] border border-[#2a475e] flex items-center justify-center text-sm font-bold text-[#3b82f6]">
