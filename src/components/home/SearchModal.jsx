...
export const SearchModal = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#101216]/80 backdrop-blur-md animate-fade-in">
            <div className="w-full max-w-115 bg-[#171a21] border border-[#2a475e] rounded-2xl p-6 shadow-2xl animate-slide-in-up">
                {/* Header */}
                ...
                {feedback && (
                    <div
                        className={`mt-4 p-4 rounded-xl flex items-start gap-3 border text-sm animate-fade-in ${feedback.type === 'success'
