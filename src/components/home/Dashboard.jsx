                ...
                <div className="p-4 border-b border-[#2a475e]/60 bg-[#171a21] flex items-center justify-between shrink-0 relative z-10">
                    <div className="flex items-center gap-3">
                        {player?.profile_url ? (
                            ...
                            <div className="w-11 h-11 rounded-xl bg-linear-to-tr from-[#1b2838] to-[#2a475e] border border-[#2a475e] flex items-center justify-center text-sm font-bold text-[#3b82f6]">
                    ...
                    <div className="flex items-center gap-3">
                        {player?.is_anonymous && (
                            <button
                                ...
                                className="py-1.5 px-3 bg-linear-to-r from-[#1b2838] to-[#2a475e] hover:from-[#2a475e] hover:to-[#3b82f6] border border-[#3b82f6]/60 text-white rounded-xl text-xs font-bold tracking-wider uppercase transition-all flex items-center gap-1.5 cursor-pointer shadow-md shadow-[#3b82f6]/5 animate-pulse-glow"
                            >
                                ...
                                <div className="glass-panel border-[#2a475e]/60 rounded-2xl p-6 flex flex-col justify-between hover:border-[#3b82f6]/60 transition-all group">
                                    ...
                                    <div className="mt-8 space-y-2">
                                        <button
                                            ...
                                            disabled={loading}
                                            className="w-full py-2.5 bg-linear-to-r from-[#1b2838] to-[#2a475e] hover:from-[#2a475e] hover:to-[#3b82f6] text-white text-xs font-bold rounded-xl border border-[#3b82f6]/60 transition-all flex items-center justify-center gap-2 cursor-pointer shadow active:scale-98"
                                        >
