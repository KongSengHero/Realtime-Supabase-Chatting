...
export const FriendContainer = () => {
  ...
  return (
    <div className="w-[300px] bg-[#171a21] border-r border-[#2a475e]/60 flex flex-col h-full relative z-10 shrink-0">
                  ...
                  <div className="flex items-center gap-2.5 overflow-hidden">
                    <div className="relative shrink-0">
                      {friend.profile_url ? (
                        ...
                        <div className="w-9 h-9 rounded-lg bg-gradient-to-tr from-[#1b2838] to-[#2a475e] border border-[#2a475e]/50 flex items-center justify-center text-xs font-bold text-[#3b82f6]">
                          {friend.player_name.substring(0, 2).toUpperCase()}
                        </div>
                      )}
                      {/* Status indicator badge */}
                      <span className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border border-[#171a21] ${
