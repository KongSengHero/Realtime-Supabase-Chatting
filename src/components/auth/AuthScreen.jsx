...
export const AuthScreen = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#101216] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {/* Main container */}
      <div className="w-full max-w-[440px] glass-panel glass-panel-glow rounded-2xl p-8 border border-[#2a475e]/60 animate-slide-in-up relative z-10">
        
        {/* Logo/Icon */}
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-[#1b2838] to-[#2a475e] border border-[#3b82f6] flex items-center justify-center shadow-lg shadow-[#3b82f6]/20 mb-4 animate-pulse-glow">
        ...
        <form onSubmit={handleAnonymousSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 bg-gradient-to-r from-[#1b2838] to-[#2a475e] hover:from-[#2a475e] hover:to-[#3b82f6] text-white font-semibold rounded-xl text-sm border border-[#3b82f6]/60 hover:border-[#3b82f6] transition-all flex items-center justify-center gap-2 cursor-pointer shadow-md active:scale-[0.98] disabled:opacity-50"
          >
