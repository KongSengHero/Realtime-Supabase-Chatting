...
export const LobbyRoom = () => {
  ...
  return (
    <div className="flex-1 bg-[#101216] flex flex-col h-full relative overflow-hidden">
      ...
      {incomingInvite && (
        <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-[400px] bg-[#171a21]/95 border border-[#3b82f6] rounded-xl p-4 shadow-xl shadow-[#3b82f6]/10 animate-slide-in-up backdrop-blur-md">
      ...
      {incomingJoinReq && isHost && (
        <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-[400px] bg-[#171a21]/95 border border-[#f59e0b] rounded-xl p-4 shadow-xl shadow-[#f59e0b]/10 animate-slide-in-up backdrop-blur-md">
          <div className="flex items-start gap-3">
      ...
      {isLocking && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#101216]/80 backdrop-blur-sm animate-fade-in">
          <div className="w-full max-w-[360px] bg-[#171a21] border border-[#2a475e] rounded-2xl p-5 shadow-2xl animate-slide-in-up">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col h-full bg-[#101216]">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {lobbyMessages.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-[#64748b] text-center max-w-[280px] mx-auto">
                ...
                return (
                  ...
                  >
                    ...
                    {msg.profileUrl ? (
                      ...
                      <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#1b2838] to-[#2a475e] border border-[#2a475e]/50 flex items-center justify-center text-[10px] font-bold text-[#3b82f6]">
                    ...
                    <div>
                      ...
                      <div
                        className={`p-3 rounded-2xl text-xs font-medium leading-relaxed leading-snug break-words ${
                          isMe
        ...
        <div className="w-[220px] bg-[#171a21] border-l border-[#2a475e]/60 flex flex-col h-full shrink-0">
                ...
                >
                  <div className="flex items-center gap-2 overflow-hidden">
                    ...
                    {p.profileUrl ? (
                      ...
                      <div className="w-7 h-7 rounded bg-gradient-to-tr from-[#1b2838] to-[#2a475e] border border-[#2a475e]/30 flex items-center justify-center text-[10px] font-bold text-[#3b82f6]">
